...
const FOOD_HEROES_DATA: Record<string, FoodHero> = {
  ...
  spirulina: {
    ...
    nutrition: {
      ...
      benefits: ["Super protein for muscles", "Detox power", "Energy boost"],
    },
    animeTraits: {
      trait: "Detox Master",
      power: "Cleanse Force - Purify and energize!",
    },
    funFact: "Spirulina is 60% protein! It was used by NASA astronauts. It's a blue-green algae that grows in lakes.",
    culturalUses: {
      dishes: ["Spirulina smoothies", "Protein powders", "Energy balls"],
      traditions: ["Modern superfood", "Athletic nutrition", "Health supplements"],
      cookingTips: ["Mix into smoothies", "Add to energy balls", "Blend with juice"],
    },
    sustainability: "Spirulina farming uses minimal water and produces oxygen. Highly sustainable!",
    xpReward: 75,
    challenge: {
      title: "Superfood Challenge",
      description: "Try a spirulina smoothie and unlock the Detox Master badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      ...
      emoji: "💚✨",
      description: "Energy-packed smoothie with spirulina boost!",
      steps: [
        "Blend 1 banana with 1 cup coconut milk",
        "Add 1 tsp spirulina powder",
    ...
    trivia: {
      question: "What percentage of spirulina is protein?",
      options: ["20%", "40%", "60%", "80%"],
      correct: 2,
      explanation: "Spirulina is 60% protein by weight! It's one of the most protein-dense foods available.",
    },
  },
  ...
  goji_berries: {
    ...
    nutrition: {
      ...
      benefits: ["Energy boost", "Immunity power", "Eye health"],
    },
    animeTraits: {
      trait: "Immunity Guardian",
      power: "Shield Force - Protect and energize!",
    },
    funFact: "Goji berries are used in traditional Chinese medicine for thousands of years. They're sweet and chewy!",
    culturalUses: {
      dishes: ["Chinese herbal teas", "Wellness soups", "Trail mix"],
      traditions: ["Traditional medicine", "Longevity foods", "Asian cuisine"],
      cookingTips: ["Soak before use", "Add to tea", "Mix in snacks"],
    },
    sustainability: "Goji berries are cultivated sustainably in Asia. Support fair trade sources!",
    xpReward: 70,
    challenge: {
      title: "Energy Quest",
      description: "Add goji berries to your snack and unlock the Immunity badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      ...
      emoji: "🔴⚡",
      description: "Chewy, sweet energy bites!",
      steps: [
        "Mix 1 cup goji berries with 1 cup almonds",
        "Add 2 tbsp honey and 1 tsp lemon zest",
    ...
    trivia: {
      question: "How long have goji berries been used in traditional medicine?",
      options: ["100 years", "500 years", "Thousands of years", "50 years"],
      correct: 2,
      explanation: "Goji berries have been used in traditional Chinese medicine for thousands of years for their wellness properties!",
    },
  },
  ...
  matcha: {
    ...
    nutrition: {
      ...
      benefits: ["Antioxidants", "Calm focus", "Energy without jitters"],
    },
    animeTraits: {
      trait: "Focus Master",
      power: "Zen Focus - Meditate and concentrate!",
    },
    funFact: "Matcha is powdered green tea from Japan! The whole leaf is consumed, giving you all the nutrients.",
    culturalUses: {
      dishes: ["Matcha tea ceremony", "Lattes", "Smoothie bowls"],
      traditions: ["Japanese tea ceremony", "Zen culture", "Modern wellness"],
      cookingTips: ["Whisk with hot water", "Use traditional whisk", "Don't boil water"],
    },
    sustainability: "Matcha cultivation is traditional and sustainable in Japan. Support quality producers!",
    xpReward: 65,
    challenge: {
      title: "Zen Moment",
      description: "Prepare and enjoy a matcha tea and unlock the Focus Master badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      title: "Traditional Matcha Tea",
      emoji: "🍵✨",
      description: "Ceremonial green tea perfection!",
      steps: [
        "Heat water to 160-170°F",
        "Whisk 1 tsp matcha powder into 2 oz water",
        "Add more hot water to fill cup",
        "Stir gently",
        "Enjoy mindfully!",
      ],
    },
    trivia: {
      question: "What is unique about matcha compared to regular green tea?",
      options: ["It's hotter", "You consume the whole leaf", "It has no caffeine", "It's sweeter"],
      correct: 1,
      explanation: "With matcha, you consume the whole leaf as powder, getting all the nutrients and benefits of green tea!",
    },
  },
  ...
  chia_seeds: {
    ...
    nutrition: {
      ...
      benefits: ["Omega-3s", "Fiber boost", "Energy sustaining"],
    },
    animeTraits: {
      trait: "Fiber Guardian",
      power: "Absorption Force - Absorb water and expand!",
    },
    funFact: "Chia seeds absorb 10x their weight in water! They expand in your stomach keeping you full longer.",
    culturalUses: {
      dishes: ["Chia pudding", "Smoothie bowls", "Overnight oats"],
      traditions: ["Aztec warrior food", "Modern health food", "Vegan recipes"],
      cookingTips: ["Soak overnight", "Add to drinks", "Mix into breakfast"],
    },
    sustainability: "Chia seeds are sustainable and require minimal water. Support organic farmers!",
    xpReward: 60,
    challenge: {
      title: "Fiber Quest",
      description: "Make chia pudding and unlock the Fiber Guardian badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      title: "Chia Pudding",
      emoji: "⚫🥛",
      description: "Creamy, filling breakfast pudding!",
      steps: [
    ...
    trivia: {
      question: "How much water do chia seeds absorb relative to their weight?",
      options: ["2x", "5x", "10x", "20x"],
      correct: 2,
      explanation: "Chia seeds absorb 10 times their weight in water! This makes them super filling and great for digestion.",
    },
  },
  ...
  kale: {
    ...
    nutrition: {
      ...
      benefits: ["Superfood strength", "Calcium rich", "Immunity boost"],
    },
    animeTraits: {
      trait: "Superfood Champion",
      power: "Vitality Force - Maximum nutrition!",
    },
    funFact: "Kale is sweeter after frost! Cold temperatures convert starches to sugars making it taste better.",
    culturalUses: {
      dishes: ["Kale chips", "Green smoothies", "Salads", "Soups"],
      traditions: ["Modern health food", "European cuisine", "Wellness trend"],
      cookingTips: ["Massage leaves for salads", "Roast for chips", "Add to soups"],
    },
    sustainability: "Kale is hardy, grows in cold weather, and requires minimal resources. Very sustainable!",
    xpReward: 70,
    challenge: {
      title: "Superfood Quest",
      description: "Try kale chips and unlock the Superfood Champion badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      ...
      emoji: "🥬✨",
      description: "Addictive, healthy snack!",
      steps: [
        "Wash and dry kale thoroughly",
        "Tear into bite-sized pieces",
        "Toss with olive oil and salt",
        "Spread on baking sheet",
        "Bake at 350°F for 15-20 minutes until crispy",
      ],
    },
    trivia: {
      question: "When does kale taste the sweetest?",
      options: ["Summer", "Fall", "After frost", "Spring"],
      correct: 2,
      explanation: "Kale tastes sweetest after frost! Cold temperatures convert starches to sugars, making it naturally sweeter.",
    },
  },
  ...
  tempeh: {
    name: "Tempeh",
    emoji: "🍲",
    scientificName: "Rhizopus oligosporus fermented soybeans",
    category: "Fermented Protein",
    seasonality: ["Year-round"],
    nutrition: {
      calories: 195,
      protein: 19,
      ...
      benefits: ["Plant protein", "Probiotic", "Digestion aid"],
    },
    animeTraits: {
      trait: "Protein Sage",
      power: "Ferment Force - Transform and strengthen!",
    },
    funFact: "Tempeh is fermented soybeans held together by mold! It has a nutty flavor and firm texture.",
    culturalUses: {
      dishes: ["Tempeh stir-fry", "Tempeh bacon", "Satay", "Curries"],
      traditions: ["Indonesian staple", "Vegan favorite", "Fermented food"],
      cookingTips: ["Steam first", "Marinate well", "Pan-fry until crispy"],
    },
    sustainability: "Tempeh is a sustainable soy product. Fermentation enhances nutrition naturally!",
    xpReward: 65,
    challenge: {
      title: "Plant Power Quest",
      description: "Cook with tempeh and unlock the Protein Sage badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      title: "Pan-Fried Tempeh",
      emoji: "🍲🔥",
      description: "Crispy, savory plant-based protein!",
      steps: [
        "Slice tempeh into ¼-inch pieces",
        "Steam for 10 minutes to soften",
        "Marinate in soy sauce, ginger, garlic",
    ...
    trivia: {
      ...
      options: ["Soy milk", "Fermented soybeans", "Tofu", "Soy flour"],
      correct: 1,
      explanation: "Tempeh is made from fermented soybeans bound together by mold. It has a firmer texture than tofu!",
    },
  },
  ...
  acai_berries: {
    ...
    nutrition: {
      ...
      benefits: ["Antioxidants", "Energy", "Rainforest superfood"],
    },
    animeTraits: {
      trait: "Antioxidant Guardian",
      power: "Jungle Force - Deep rainforest power!",
    },
    funFact: "Acai berries are from the Amazon rainforest! They're loaded with antioxidants and used in açai bowls.",
    culturalUses: {
      dishes: ["Acai bowls", "Smoothies", "Energy drinks"],
      traditions: ["Brazilian superfood", "Rainforest harvest", "Health trend"],
      cookingTips: ["Use frozen puree", "Top with granola", "Add to smoothies"],
    },
    sustainability: "Support sustainable rainforest harvesting. Fair trade acai supports indigenous communities!",
    xpReward: 75,
    challenge: {
      title: "Rainforest Quest",
      description: "Try an acai bowl and unlock the Antioxidant Guardian badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      ...
      emoji: "🟣🌴",
      description: "Rainbow superfood breakfast!",
      steps: [
        "Blend 1 cup frozen acai with ½ cup almond milk",
        "Pour into bowl",
        "Top with granola and berries",
        "Add coconut flakes and honey",
        "Enjoy immediately!",
      ],
    },
    trivia: {
      question: "Where do acai berries come from?",
      options: ["Africa", "Asia", "Amazon rainforest", "Mediterranean"],
      correct: 2,
      explanation: "Acai berries come from the Amazon rainforest in South America! They're packed with antioxidants.",
    },
  },
  ...
  nutritional_yeast: {
    ...
    nutrition: {
      ...
      protein: 8,
      fiber: 1,
      vitamins: ["B vitamins", "B12 fortified"],
      minerals: ["Zinc", "Selenium"],
      benefits: ["B vitamins", "Umami taste", "Vegan cheese flavor"],
    },
    animeTraits: {
      trait: "Flavor Master",
      power: "Umami Force - Add taste without salt!",
    },
    funFact: "Nutritional yeast tastes cheesy but it's not dairy! It's an inactive yeast loaded with B vitamins.",
    culturalUses: {
      dishes: ["Popcorn topping", "Pasta seasoning", "Salad dressing", "Vegan cheese"],
      traditions: ["Vegan cooking", "Health food", "Flavor substitute"],
      cookingTips: ["Sprinkle on popcorn", "Add to smoothies", "Mix in salads"],
    },
    sustainability: "Nutritional yeast is produced sustainably and adds nutrients to vegan diets!",
    xpReward: 55,
    challenge: {
      title: "Flavor Quest",
      description: "Use nutritional yeast in a recipe and unlock the Flavor Master badge!",
      requirement: 1,
      duration: "7 days",
    },
    recipe: {
      title: "Cheesy Popcorn",
      emoji: "💛🍿",
      description: "Savory, umami-packed snack!",
      steps: [
        "Pop 3 tbsp popcorn kernels",
        "Toss with melted butter",
        "Sprinkle 3 tbsp nutritional yeast",
        "Add salt and pepper to taste",
        "Enjoy guilt-free!",
      ],
    },
    trivia: {
      question: "What gives nutritional yeast its cheesy flavor?",
      options: ["Dairy", "Umami compounds", "Salt", "Artificial flavoring"],
      correct: 1,
      explanation: "Nutritional yeast contains umami compounds (glutamates) that create a savory, cheese-like taste naturally!",
    },
  },
};

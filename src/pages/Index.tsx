...
const Index = () => {
  ...
  const getFoodData = () => {
    ...
    const benefitMap: {[key: string]: string} = {
      "Energy boost": "food_benefits.energy_boost",
      "Happy tummy": "food_benefits.happy_tummy",
      "Super eyes": "food_benefits.super_eyes",
      "Crunchy fun": "food_benefits.crunchy_fun",
      "Strong teeth": "food_benefits.strong_teeth",
      "Yummy snack": "food_benefits.yummy_snack",
      "Strong bones": "food_benefits.strong_bones",
      "Tasty treat": "food_benefits.tasty_treat",
      "Brain power": "food_benefits.brain_power",
      "Healthy fats": "food_benefits.healthy_fats",
      "Omega-3": "food_benefits.omega_3",
      "Strong muscles": "food_benefits.strong_muscles",
      "Iron boost": "food_benefits.iron_boost",
      "Energy": "food_benefits.energy",
      "Complete protein": "food_benefits.complete_protein",
      "Brain food": "food_benefits.brain_food",
      "Probiotics": "food_benefits.probiotics",
      "Muscle recovery": "food_benefits.muscle_recovery",
      "Vitamin A": "food_benefits.vitamin_a",
      "Complex carbs": "food_benefits.complex_carbs",
      "Lean protein": "food_benefits.lean_protein",
      "B vitamins": "food_benefits.b_vitamins",
